	...
	return (
		<footer className="dark:bg-gray-900 text-white ">
			<div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
				<div className="md:flex md:justify-between md:items-start gap-2">
					...
					<div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
						<div>
							...
							<ul className="text-gray-500 dark:text-gray-400 font-medium">
								<li className="mb-4">
									<a href="/" className="hover:underline">Connected Brain</a>
								</li>
								{/*<li>*/}
					...
					<div className={'w-full flex flex-col justify-center items-start md:max-w-xs'}>
						...
						<div
							className={cn('w-full flex justify-between items-center gap-2 rounded-lg p-1 border-[1px] border-gray-800', `bg-[${colors.input}]`)}>
							<input type="email" placeholder="Your email"
										 className={cn('w-full px-1 outline-none bg-opacity-0', `bg-gray-600`)} />
							<button
								className="w-fit px-2 p-1 bg-gray-600 transition-all rounded-md text-white font-semibold hover:bg-gray-500 dark:bg-blue-500">Subscribe
							</button>
						</div>
					</div>
				</div>
          ...
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a
						href="/" className="hover:underline">ConnectedBrain™</a>. All Rights Reserved.
          </span>
