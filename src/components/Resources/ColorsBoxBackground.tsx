...
function ColorsBoxDisplay({ numberOfBoxes = 10 }: { numberOfBoxes?: number }) {
	const [renderBoxes, setRenderBoxes] = React.useState<Array<{ isHighlighted: boolean; isHovered: boolean }>>([]);
...
function ColorsBoxBackground({ children }: ColorsBoxBackgroundProps) {
	return (
