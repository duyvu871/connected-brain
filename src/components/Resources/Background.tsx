			...
			<div className={'flex flex-col'}>
				<div className={'grid grid-cols-[1fr_12fr_1fr]'}>
					...
					<div className={cn(
						...
						<div className={cn(borderDashStyle, 'w-64 h-14 border-r-[1px] border-l-[1px]')}></div>
					</div>
					<div className={cn(borderDashStyle, 'h-14 border-b-[1px] border-l-[1px]')}></div>
				</div>
				...
				<div className={'grid grid-cols-[1fr_12fr_1fr] grid-rows-1 h-fit'}>
					...
					<div className={cn(borderDashStyle, ' border-b-[1px] border-l-[1px]')}></div>
				</div>

				<div className={'grid grid-cols-[1fr_12fr_1fr] grid-rows-1 h-fit'}>
					<div className={cn(borderDashStyle, ' border-b-[1px] border-r-[1px]')}></div>
					<div className={cn(borderDashStyle, ' border-b-[1px]')}>
							...
							<div
								...
								<span className={'capitalize text-gray-400 text-2xl flex justify-center items-center font-semibold'}>
									<Button variant={'outline'}
													className={'capitalize flex justify-center items-center p-6 px-4 font-extrabold rounded-2xl rounded-tr-[0] rounded-bl-[0] text-xl bg-gray-200 text-[#626467] text-gray-800 transition-colors hover:bg-opacity-90'}>
										Start Now
				...
				<div className={'grid grid-cols-[1fr_12fr_1fr]'}>
					<div className={cn(borderDashStyle, 'h-14 border-r-[1px]')}></div>
					<div className={cn(borderDashStyle, 'h-14')}>
					</div>
					<div className={cn(borderDashStyle, 'h-14 border-l-[1px]')}></div>
				</div>
			</div>
		</div>
	);
