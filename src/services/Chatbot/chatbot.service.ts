...
import { UserInterface as UserType } from 'types/user.type'; // Assuming UserType has '_id' as ObjectId
import { MessageHistoryType, SectionMessageGeneratedType } from 'types/features/Chatbot'; // Assuming these types have '_id' as ObjectId
...
export class ChatbotService {
	...
	private async loadDB() {
		...
		this.db = client.db(process.env.DB_NAME as string);
