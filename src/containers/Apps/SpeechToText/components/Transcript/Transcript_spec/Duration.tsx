...
const DurationTime: FC<any> = () => {
	...
	return (
		<Flex direction={'column'} justify={'center'} align={'start'} className={' flex-grow'}>
			<Box className={'white text-3xl font-semibold'}>
			...
			<Box className={'flex-grow'}>
				<svg
					...
					<rect
						...
						height='100'
						rx='5'
						transform='rotate(-180 252.254 174.255)'
						fill='#BEBEBE'
					/>
					<rect
						x='269.254'
						...
						height='70'
						rx='5'
						transform='rotate(-180 269.254 158.255)'
						fill='#BEBEBE'
					/>
					<rect
						x='286.254'
						...
						height='50'
						rx='5'
						transform='rotate(-180 286.254 149.255)'
						fill='#BEBEBE'
					/>
					<rect
						x='235.254'
						...
						height='200'
						rx='5'
						transform='rotate(-180 235.254 224.551)'
						fill='#BEBEBE'
					/>
					<rect
						x='184.263'
						...
						height='50'
						rx='5'
						transform='rotate(-180 184.263 150.44)'
						fill='#BEBEBE'
					/>
					<rect
						x='201.261'
						...
						height='250'
						rx='5'
						transform='rotate(-180 201.261 250.145)'
						fill='#BEBEBE'
					/>
					<rect
						x='167.266'
						...
						height='130'
						rx='5'
						transform='rotate(-180 167.266 190.737)'
						fill='#BEBEBE'
					/>
					<rect
						x='218.256'
						...
						height='150'
						rx='5'
						transform='rotate(-180 218.256 199.847)'
						fill='#BEBEBE'
					/>
				</svg>
			</Box>
