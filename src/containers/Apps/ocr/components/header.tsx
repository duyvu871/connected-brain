...
export default function Header(): React.ReactNode {
	...
	return (
		<header
			className={
				'flex w-full flex-col gap-3 p-3 md:h-16 md:flex-row md:items-center lg:px-4 bg-black/95 backdrop-blur bg-opacity-0 supports-[backdrop-filter]:bg-black/60'
			}>
			<Box className={'flex w-full items-center gap-8'}>
				<Box className={'flex items-center gap-2'}>
					...
					{!isStarterScreen && <Box className={'text-white text-lg font-bold'}>OCR</Box>}
				</Box>
